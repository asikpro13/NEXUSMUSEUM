...
class _AboutMuseumPageState extends State<AboutMuseumPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        Padding(
            ...
            SizedBox(height: 10),
            Text('Торжественное открытие Nexusmuseum состоялось 15 сентября 2015 года. Первой экспозицией стала "Археология будущего" — провокационный проект, где цифровые инсталляции соседствовали с античными артефактами. Выставка вызвала оживлённые дискуссии в профессиональной среде, но именно этот синтез старого и нового стал визитной карточкой музея.',
              style: GoogleFonts.inter(fontSize: 16),),
            SizedBox(height: 10),
            Text('В 2016 году музей представил свою первую масштабную выставку "Код культуры", где экспонаты из разных эпох были организованы не по хронологическому, а по тематическому принципу. Посетители могли проследить, как одна и та же идея — например, концепция героизма или образ дерева — воплощалась в искусстве Древнего Египта, Средневековья и цифровой эпохи.',style: GoogleFonts.inter(fontSize: 16),),
            SizedBox(height: 10,),
            Text('Критическим моментом этого периода стало создание собственного реставрационного центра и начало формирования постоянной коллекции. Особую гордость составило приобретение архива русского авангардиста Петра Лещенко и коллекции античных килик VI века до н.э.',
              style: GoogleFonts.inter(fontSize: 16),),
            SizedBox(height: 10,),
            Text(
            ...
            SizedBox(height: 10),
            Text('2018 год ознаменовался масштабной реконструкцией и расширением площадей. Под руководством Дмитрия Волкова был достроен современный корпус с "умными" фасадами, меняющими прозрачность в зависимости от освещения. Технологические решения Алексея Семёнова позволили создать интерактивные залы с дополненной реальностью и иммерсивными инсталляциями.',
              style: GoogleFonts.inter(fontSize: 16),),
            SizedBox(height: 10,),
            Text('В этот период Nexusmuseum начал активно развивать международное сотрудничество. Были заключены партнёрские соглашения с Центром Помпиду в Париже, музеем Гуггенхайма в Бильбао и Токийским национальным музеем. Совместный проект "Трансформация взгляда" с нью-йоркским МОМА стал одним из самых посещаемых в сезоне 2019-2020 годов.',style: GoogleFonts.inter(fontSize: 16),),
            SizedBox(height: 10,),
            Text('Музей также укрепил свои исследовательские позиции, открыв Лабораторию цифровой гуманитаристики и Школу музейного кураторства. Ежегодная конференция "Nexus: искусство искусство в эпоху технологий" стала важной площадкой для профессионалов со всего мира.',
              style: GoogleFonts.inter(fontSize: 16),
            ),
                SizedBox(height: 50),
              ],
